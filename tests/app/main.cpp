...
BOOST_AUTO_TEST_CASE( three_node_network )
{
   ...
   try {
      ...
      set_option( cfg, "p2p-endpoint", app1_p2p_endpoint_str );
      set_option( cfg, "genesis-json", genesis_file );
      ...
      wait_for( node_startup_wait_time, [&app1,port] () {
      ...
      set_option( cfg2, "genesis-json", genesis_file );
      set_option( cfg2, "seed-nodes", app2_seed_nodes_str );
      app2.initialize(app2_dir.path(), sharable_cfg2);

      BOOST_TEST_MESSAGE( "Starting app2 and waiting for connection" );
      app2.startup();

      wait_for( node_startup_wait_time, [&app1] () {
      ...
      wait_for( broadcast_wait_time, [db1] () {
      ...
      set_option( cfg3, "genesis-json", genesis_file );
      set_option( cfg3, "seed-nodes", app3_seed_nodes_str );
      set_option( cfg3, "p2p-accept-incoming-connections", false );
      ...
      wait_for( new_peer_wait_time, [&app2] () {
