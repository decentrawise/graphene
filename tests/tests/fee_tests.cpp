...
{ // create orders before hard fork, cancel them after hard fork
   try
   {
      ...
      limit_order_id_type bo1_id = create_sell_order(   bob_id, asset(1000, usd_id), asset(100000), max_exp, cer )->get_id();
      ...
      limit_order_id_type bo3_id = create_sell_order(   bob_id, asset(500, usd_id), asset(1500), max_exp, cer )->get_id();
      ...
      limit_order_id_type bo5_id = create_sell_order(   bob_id, asset(255, usd_id), asset(408), max_exp, cer )->get_id();
...
{ // create orders before hard fork, cancel them after hard fork
   try
   {
      ...
      limit_order_id_type bo3_id = create_sell_order(   bob_id, asset(500, usd_id), asset(15000), max_exp, cer )->get_id();
      BOOST_CHECK( db.find( bo3_id ) != nullptr );
      ...
      limit_order_id_type bo11_id = create_sell_order(   bob_id, asset(388, usd_id), asset(6984), max_exp, cer )->get_id();
      ...
      limit_order_id_type bo12_id = create_sell_order(   bob_id, asset(213, usd_id), asset(3621), exp2, cer )->get_id();
      ...
      limit_order_id_type bo5_id = create_sell_order(   bob_id, asset(255, usd_id), asset(4080), max_exp, cer )->get_id();
      BOOST_CHECK( db.find( bo5_id ) != nullptr );
      ...
      limit_order_id_type bo7_id = create_sell_order(   bob_id, asset(1003, usd_id), asset(100000), max_exp, cer )->get_id();
      BOOST_CHECK( db.find( bo7_id ) != nullptr );
      // bo8: will expire, won't match, fee in usd
      limit_order_id_type bo8_id = create_sell_order(   bob_id, asset(803, usd_id), asset(100000), exp1, cer )->get_id();
      ...
      limit_order_id_type bo9_id = create_sell_order(   bob_id, asset(505, usd_id), asset(1515), max_exp, cer )->get_id();
      ...
      limit_order_id_type bo13_id = create_sell_order(   bob_id, asset(364, usd_id), asset(546), max_exp, cer )->get_id();
