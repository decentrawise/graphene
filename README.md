...
[Graphene](https://github.com/decentrawise/graphene) is the Graphene Protocol blockchain node and command-line wallet software.

Visit [DecentraWise](https://decentrawise.com) to learn about Graphene Protocol and join the community at our [Telegram](https://t.me/decentrawise).


- [Graphene Protocol](#graphene-protocol)
...
Build instructions and additional documentation are available in the [Wiki](https://github.com/decentrawise/graphene/wiki).

Prebuilt binaries can be found in the [releases page](https://github.com/decentrawise/graphene/releases) for download.
...
**Build Node And Command-Line Wallet:**
    ...
    git clone https://github.com/decentrawise/graphene.git
    cd graphene
...
**Upgrade Node And Command-Line Wallet:**
    ...
    cd graphene
    git remote set-url origin https://github.com/decentrawise/graphene.git
    git checkout main
...
* Graphene requires a 64-bit operating system to build, and will not build on a 32-bit OS. Tested operating systems:
...
* Graphene requires [Boost](https://www.boost.org/) libraries to build, supports version `1.58` to `1.83`.
...
* Graphene requires [OpenSSL](https://www.openssl.org/) libraries to build, supports version `1.0.2` to `1.1.1`.
...
**IMPORTANT:** By default the node will start in reduced memory mode by using some of the commands detailed in [Memory reduction for nodes](https://github.com/decentrawise/graphene/wiki/Memory-reduction-for-nodes).
In order to run a full node with all the account histories which usually unnecessary, you need to remove `partial-operations` and `max-ops-per-account` from your config file. Please note that a full node will need a lot of RAM to operate and required memory is growing fast.
...
[wallet.hpp](https://github.com/decentrawise/graphene/blob/main/libraries/wallet/include/graphene/wallet/wallet.hpp) source code file.
Corresponding documentation can be found in the [Doxygen documentation](https://decentrawise.github.io/graphene-docs/classgraphene_1_1wallet_1_1wallet__api.html).
...
Technical support is available in our [Telegram](https://t.me/decentrawise).

Graphene bugs can be reported directly to the [issue tracker](https://github.com/decentrawise/graphene/issues).

Questions can be posted in [Github Discussions](https://github.com/decentrawise/graphene/discussions).

Up to date online Doxygen documentation can be found at [https://decentrawise.github.io/graphene-docs](https://decentrawise.github.io/graphene-docs/hierarchy.html).
...
[database_api.hpp](https://github.com/decentrawise/graphene/blob/main/libraries/app/include/graphene/app/database_api.hpp)
and [api.hpp](https://github.com/decentrawise/graphene/blob/main/libraries/app/include/graphene/app/api.hpp).
Corresponding documentation can be found in Doxygen:
* [database API](https://decentrawise.github.io/graphene-docs/classgraphene_1_1app_1_1database__api.html)
* [other APIs](https://decentrawise.github.io/graphene-docs/namespacegraphene_1_1app.html)
...
about APIs for the [node](https://decentrawise.github.io/graphene-docs/namespacegraphene_1_1app.html) and the
[wallet](https://decentrawise.github.io/graphene-docs/classgraphene_1_1wallet_1_1wallet__api.html).
...
- What is the meaning of `a.b.c` numbers?
    ...
    [protocol/types.hpp](https://github.com/decentrawise/graphene/blob/main/libraries/protocol/include/graphene/protocol/types.hpp)
    and `GRAPHENE_DEFINE_IDS(chain, implementation_ids ...)` in [chain/types.hpp](https://github.com/decentrawise/graphene/blob/main/libraries/chain/include/graphene/chain/types.hpp).
...
- The answer to the previous question was really confusing.  Can you make it clearer?
    ...
    your account's ID will be `1.2.9735`.  Account `0` is special (it's the "council account",
    ...
    your asset's ID will be `1.3.29`.  Asset `0` is special (it's IND, which is considered the "core asset").
...
Graphene is under the MIT license. See [LICENSE](https://github.com/decentrawise/graphene/blob/main/LICENSE.md)
