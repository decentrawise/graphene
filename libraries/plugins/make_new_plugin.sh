...
echo "2- Add 'graphene_$pluginName' to ../../programs/graphened/CMakeLists.txt with the other plugins."
echo "3- Include plugin header file '#include <graphene/$pluginName/$pluginName.hpp>' to ../../programs/graphened/main.cpp."
echo "4- Initialize plugin with the others with 'auto ${pluginName}_plug = node->register_plugin<$pluginName::$pluginName>();' in ../../programs/graphened/main.cpp"
echo "5- cmake and make"
echo "6- Start plugin with './../programs/graphened/graphened --plugins \"$pluginName\"'. After the seed nodes are added you start to see see a msgs from the plugin 'onBlock' "
