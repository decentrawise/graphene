...
namespace graphene { namespace protocol {
   ...
   void chain_parameters::safe_copy(chain_parameters& to, const chain_parameters& from)
   {
      ...
      to.maximum_validator_count = from.maximum_validator_count;
      ...
      to.validator_pay_per_block = from.validator_pay_per_block;
      to.validator_pay_vesting_seconds = from.validator_pay_vesting_seconds;
