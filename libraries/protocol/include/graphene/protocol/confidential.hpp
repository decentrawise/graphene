...
namespace graphene { namespace protocol {
    ...
    *
    * Stealth Transfers enable users to maintain their financial privacy, even though all transactions
    * are public.
    * 
    ...
    *
    * Stealth transfers can have an arbitrarily large size, therefore the transaction fee for
    * stealth transfers is based purely on the data size of the transaction.
    */
   ///@{
   ...
   /**
    *  When sending a stealth transfer we assume users are unable to scan
