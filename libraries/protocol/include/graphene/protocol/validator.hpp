...
namespace graphene { namespace protocol { 
  ...
  /**
   ...
   struct validator_update_operation : public base_operation
   {
      ...
      optional< public_key_type > new_block_producer_key;
...
FC_REFLECT( graphene::protocol::validator_create_operation, (fee)(validator_account)(url)(block_producer_key) )

FC_REFLECT( graphene::protocol::validator_update_operation::fee_parameters_type, (fee) )
FC_REFLECT( graphene::protocol::validator_update_operation, (fee)(validator)(validator_account)(new_url)(new_block_producer_key) )
