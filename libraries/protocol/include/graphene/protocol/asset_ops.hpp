...
namespace graphene { namespace protocol { 
   ...
   /**
    * @brief Transfers CORE from the fee pool of a specified asset back to the issuer's balance

    * @param fee Payment for the operation execution
    * @param issuer Account which will be used for transfering CORE
    * @param asset_id Id of the asset whose fee pool is going to be drained
    * @param amount_to_claim Amount of CORE to claim from the fee pool
