...
fc::variant_object get_config()
{
   ...
   result[ "GRAPHENE_DEFAULT_MAX_VALIDATORS" ] = GRAPHENE_DEFAULT_MAX_VALIDATORS;
   result[ "GRAPHENE_DEFAULT_MAX_COUNCIL" ] = GRAPHENE_DEFAULT_MAX_COUNCIL;
   result[ "GRAPHENE_DEFAULT_MAX_PROPOSAL_LIFETIME_SEC" ] = GRAPHENE_DEFAULT_MAX_PROPOSAL_LIFETIME_SEC;
   result[ "GRAPHENE_DEFAULT_COUNCIL_PROPOSAL_REVIEW_PERIOD_SEC" ] = GRAPHENE_DEFAULT_COUNCIL_PROPOSAL_REVIEW_PERIOD_SEC;
   ...
   result[ "GRAPHENE_DEFAULT_VALIDATOR_PAY_PER_BLOCK" ] = GRAPHENE_DEFAULT_VALIDATOR_PAY_PER_BLOCK;
   result[ "GRAPHENE_DEFAULT_VALIDATOR_PAY_VESTING_SECONDS" ] = GRAPHENE_DEFAULT_VALIDATOR_PAY_VESTING_SECONDS;
   ...
   result[ "GRAPHENE_VALIDATOR_ACCOUNT" ] = fc::variant(GRAPHENE_VALIDATOR_ACCOUNT, GRAPHENE_MAX_NESTED_OBJECTS);
