...
fc::variant_object get_config()
{
   ...
   result[ "GRAPHENE_DEFAULT_MAX_PRODUCERS" ] = GRAPHENE_DEFAULT_MAX_PRODUCERS;
   ...
   result[ "GRAPHENE_DEFAULT_PRODUCER_PAY_VESTING_SECONDS" ] = GRAPHENE_DEFAULT_PRODUCER_PAY_VESTING_SECONDS;
