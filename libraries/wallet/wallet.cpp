...
} FC_CAPTURE_AND_RETHROW( (keys) ) } // GCOVR_EXCL_LINE
...
{ try {
   ...
   return conf;
} FC_CAPTURE_AND_RETHROW( (from_blind_account_key_or_label)(to_account_id_or_name)(amount_in)(symbol) ) } // GCOVR_EXCL_LINE
                                                    ...
                                                    bool to_temp )const
{
   ...
   return confirm;
} FC_CAPTURE_AND_RETHROW( (from_key_or_label)(to_key_or_label)(amount_in)(symbol)(broadcast)(confirm) ) } // GCOVR_EXCL_LINE
...
{ try {
   ...
   return confirm;
} FC_CAPTURE_AND_RETHROW( (from_account_id_or_name)(asset_symbol)(to_amounts) ) } // GCOVR_EXCL_LINE
...
} FC_CAPTURE_AND_RETHROW( (account)(catalog) ) } // GCOVR_EXCL_LINE
